...
import org.nasdanika.models.python.ecore.EcoreGenPythonProcessorsFactory;
 ...
 *
 */
public class TestPythonModelDocGen {
	
	@Test
	public void testGeneratePythonModelDoc() throws IOException, DiagnosticException {
		ProgressMonitor progressMonitor = new NullProgressMonitor(); // new PrintStreamProgressMonitor();
		MutableContext context = Context.EMPTY_CONTEXT.fork();
		Consumer<Diagnostic> diagnosticConsumer = d -> d.dump(System.out, 0);
		List<Function<URI,Action>> actionProviders = new ArrayList<>();		
		EcoreGenPythonProcessorsFactory ecoreGenFamilyProcessorFactory = new EcoreGenPythonProcessorsFactory(context);		
		...
		File output = new File(actionModelsDir, "python.xmi");
		...
		String siteMapDomain = "https://python.models.nasdanika.org";		
